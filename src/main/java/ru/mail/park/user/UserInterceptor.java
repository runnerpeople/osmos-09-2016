...
//            connectionRepository.createConnectionRepository(SecurityContext.getCurrentUser().getId()).removeConnections("vkontakte");
//            userCookieGenerator.removeCookie(response);
//            SecurityContext.remove();
//        }
//    }
...
//        return connectionRepository.createConnectionRepository(userId).findPrimaryConnection(VKontakte.class) != null;
//    }
//
//}
